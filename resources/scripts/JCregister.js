...
var jcAddress= "0x6c9e836501929157ad9f96c2e9fe6ef3bd755c7a";

var register = new web3.eth.Contract(rcAbi);
register.options.address=rcAddress;

register.methods.methodRegister("Judge", "JC", "0x9abf7020cc405fce60fdfb84168fb9457bde52e2", "0x44d13e0c0d91a2ebe570c58cdadef2b99bf55bc1", "0x44d13e0c0d91a2ebe570c58cdadef2b99bf55bc1",  jcAddress).send({
	from: "0xe113bd7868b9a8761a7ae86603a9e9861a56815f",
	gas: 10000000
}, function (error, result){
	if(!error){
		console.log('register JC transactionHash: ' + result);
 ...
 register.methods.getContractAddr("Judge").call({
	from: "0xe113bd7868b9a8761a7ae86603a9e9861a56815f",
	gas: 10000000
}, function (error, result){
	if(!error){
        console.log('jc address:' + result);
	}
	else
		console.log(error);
 })
